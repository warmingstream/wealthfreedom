...
!function (e, t) {
    ...
    e.fn[h] = function (t) {
        ...
        if (i) {
            var r, n = this, s = N.exec(i[0]), a = s[2], l = (s[1] || "POST").toUpperCase(), u = {}, tName = t.name;
            var pos = tName.indexOf(".");
            if(pos > 0)
                tName = tName.substr(pos+1, tName.length -1);
            return u[tName] = t.value, i[1] && e.map(i.slice(1), function (t) {
                u[e.trim(t)] = n.$el.find(':input[name="' + t + '"]').val()
            }), u = e.param(u), "POST" === l && (r = a.indexOf("?"), -1 !== r && (u += "&" + a.substring(r + 1, a.length), a = a.substring(0, r))), e.ajax({url: a, type: l, dataType: 'json', data: u, async: !0, cache: !1})
        }
    }, filter: function (e, t) {
