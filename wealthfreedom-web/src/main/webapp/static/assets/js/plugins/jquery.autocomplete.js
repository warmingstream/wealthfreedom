(function(a) {
    ...
    a.Autocompleter.defaults = {inputClass:"ac_input",resultsClass:"ac_results",loadingClass:"ac_loading",minChars:1,delay:400,matchCase:false,matchSubset:true,matchContains:false,cacheLength:10,max:100,mustMatch:false,extraParams:{},selectFirst:true,formatItem:function(b) {
        return b[0]
    },formatMatch:null,autoFill:false,width:0,top:0,multiple:false,multipleSeparator:", ",highlight:function(c, b) {
    ...
    a.Autocompleter.Select = function(e, j, l, p) {
        ...
        return{display:function(u, t) {
            ...
            var v = a(j).offset();
            c.css({width:typeof e.width == "string" || e.width > 0 ? e.width : a(j).width(),top:typeof e.top == "string" || e.top > 0 ? e.top : v.top + j.offsetHeight,left:v.left + (typeof e.left != "undefined" ? parseInt(e.left) : 0)}).show();
            if (e.scroll) {
                o.scrollTop(0);
