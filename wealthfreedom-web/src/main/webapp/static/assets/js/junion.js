    ...
    define(['jquery'], function ($) {
        ...
        return (function(){
            ...
            JUN.ui = {
                load: function(options){
                    ...
                    JUN.ajax.html({
                        ...
                        success: function(data){
                            //$('.container-box').html(data);
                            $('.container-box').empty();
                            $('.container-box').append(data);
                            $('.preloader').hide();
                        }
                    });
                ...
                loadPage: function($loader ,url,cache){
                    ...
                    if($.type(url) === "string"){
                        ...
                        defaultOption.cache = defaultCache;
                    }else{
                        defaultOption =  $.extend(defaultOption,url);
                    }
                    $.ajax(defaultOption);
                },

                appendPage :function($loader ,url,cache){
                    var defaultCache = false;
                    defaultCache = cache || defaultCache;
                    var defaultOption = {
                        async:true,
                ...
                table: function(options){
                    ...
                    var settings = {
                        ...
                        fnDrawCallback: function() {
                            if(options.fnDrawCallback && $.isFunction(options.fnDrawCallback)){
